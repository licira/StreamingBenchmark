...
public class JoinBolt<K, V, R> extends BaseBasicBolt {
    ...
    private static final Logger logger = Logger.getLogger(JoinBolt.class);
     ...
     */
    public JoinBolt(String component1, TimeDuration windowDuration1, String component2, TimeDuration windowDuration2) {
...
//        dataContainer2 = new LinkedList<>();
    ...
    public JoinBolt(String component1, TimeDuration windowDuration1,
                    String component2, TimeDuration windowDuration2,
